...
function Cart() {
        ...
        <tr key={i}>
          ...
          <td className="cart_quantity">
            <div className="cart_quantity_button">
              <button className="cart_quantity_up" onClick={(e,i)=> plusQuantity(e,i)} >
                {" "}
                +{" "}
              </button>
              <input
                ...
                min={1}
              />
              <button className="cart_quantity_down"  onClick={(e,i)=> minusQuantity(e,i)}>
                {" "}
                -{" "}
              </button>
            </div>
          ...
          <td className="cart_total">
            <p className="cart_total_price">{formatter.format(Number(items[item].GiaNhap * items[item].Quantity * 1.4))}</p>
          </td>
  ...
  const plusQuantity=(e,i)=>{
    ...
    setItems(()=>{items[i].Quantity=value+1 return items})
