...
function Checkout() {
  ...
  const displatWard=(list)=>{
    return Object.keys(list).map((item, i) => {
      return(
        <optionvalue={district[item].code}>{ward[item].name}</optionvalue=>
      )
    })
  }
  useEffect(()=>{
              ...
              <div className="col-sm-4">
                <div className="shopper-info">
                  ...
                  <form>
                    ...
                    <select type="text" placeholder="Địa chỉ" onChange={(e)=>{console.log(e.target.value);getDistrict(e.target.value)}}>
                      <option hidden value="">
                        ---Tỉnh/Thành---
                      </option>
