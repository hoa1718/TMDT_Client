    ...
    return Object.keys(list).map((item, index) => {
      return (
        <div className="radio_wrapper">
          ...
          <p>{shipping[item].SDT}</p>
          <p>{shipping[item].DiaChi}</p>
        </div>
      );
    });
  };
          ...
          <div className="shopper-informations">
            <div className="row">
              <div className="col-sm-4">
                {ReactSession.get('user') ? <div className="order-message"> <p>Hình thức thanh toán</p>{displayShipping(shipping)}</div> : <div className="shopper-info order-message">
