              ...
              <div className="col-sm-4">
                <div className="shopper-info">
                  ...
                  <form>
                    ...
                    <input type="text" placeholder="Số điện thoại" onChange={(e)=>setName(e.target.value)} />
                    <input type="text" placeholder="Địa chỉ" onChange={(e)=>setName(e.target.value)}></input>
