...
function Checkout() {
  ...
  const checkOut =()=>{
    const provinceChoose= document.querySelector("#province").innerText;
    const districtChoose= document.querySelector("#district").innerText;
    const wardChoose= document.querySelector("#ward").innerText;
