...
function Checkout() {
  ...
  const checkOut =()=>{
    ...
    const data={
      TenNguoiNhan:name,
      SDT:phone,
      DiaChi:`${address},${provinceSel.options[provinceSel.selectedIndex].text},${districtSel.options[districtSel.selectedIndex].text},${provinceSel.options[provinceSel.selectedIndex].text}`,
    }
    console.log( provinceSel.options[provinceSel.selectedIndex].text);
  }
  useEffect(()=>{
    getProvince()
  },[])
