    ...
    return Object.keys(list).map((item, index) => {
      if(Number(shipping[item].DiaChiMacDinh)===1){
        return(
          ...
          <input type={"radio"} name="shipping" value={shipping[item].DiaChi} checked onChange={(e)=>setAddress(e.target.value)}></input>{" "}
          ...
          <div className="shopper-informations">
            <div className="row">
              <div className="col-sm-4">
                {ReactSession.get('user') ? <div className="order-message"> <p>Địa chỉ</p>{displayShipping(shipping)}</div> : <div className="shopper-info order-message">
