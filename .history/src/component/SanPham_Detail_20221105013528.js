...
function Detail({props}) {
  ...
  function ImageFromFireBase(number) {
    const getUrlFromFirebase = async () => {
        ...
        res.items.map(á(item,i)=>{
          const imgRef = res.items[number.number];
  ...
  // return <img src={imageUrl} style={{ width: "100%" }} alt="image"></img>;
}
  return (
          ...
          <div className="slideshow-container">
            <div className="mySlides  ">
              ...
              <div className="numbertext">{slideIndex}/ 3</div>
                    <ImageFromFireBase number={1}></ImageFromFireBase>
